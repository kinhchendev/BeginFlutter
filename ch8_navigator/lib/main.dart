...
import 'package:ch8_navigator/about.dart';
import 'package:ch8_navigator/gratitude.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _openPageGratitude(
    ...
    print('Return from Gratitude pop = $_gratitudeResponse');
    setState(() {
      if (_gratitudeResponse.isNotEmpty) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () => _openPageAbout(buildContext: context, fullscreenDialog: true),
